...
| Skill | 说明 |
|-------|------|
| [Java](skills/java/SKILL.md) | Java 语言开发 |
| [Kotlin](skills/kotlin/SKILL.md) | Kotlin 语言开发 |
| [Go](skills/go/SKILL.md) | Go 语言开发 |
| [Python](skills/python/SKILL.md) | Python 语言开发 |
| [C](skills/c/SKILL.md) | C 语言开发 |
| [C++](skills/cpp/SKILL.md) | C++ 语言开发 |
| [C# / .NET](skills/csharp/SKILL.md) | C# / .NET 开发 |
| [Rust](skills/rust/SKILL.md) | Rust 语言开发 |
| [TypeScript](skills/typescript/SKILL.md) | TypeScript 类型安全开发 |
| [JavaScript](skills/javascript/SKILL.md) | JavaScript 开发 |
| [Dart](skills/dart/SKILL.md) | Dart 语言开发 |
| [PHP](skills/php/SKILL.md) | PHP 后端开发 |
| [R](skills/r/SKILL.md) | R 统计分析开发 |
| [Perl](skills/perl/SKILL.md) | Perl 脚本开发 |
| [Visual Basic](skills/vb/SKILL.md) | Visual Basic / VBA 开发 |
| [Delphi](skills/delphi/SKILL.md) | Delphi 桌面应用开发 |
| [Fortran](skills/fortran/SKILL.md) | Fortran 科学计算开发 |
| [MATLAB](skills/matlab/SKILL.md) | MATLAB 数值计算开发 |
...
| Skill | 说明 |
|-------|------|
| [HTML / CSS / JS](skills/html-css-js/SKILL.md) | Web 前端基础开发 |
| [Vue](skills/vue/SKILL.md) | Vue 前端开发 |
| [Vue + TypeScript](skills/vue-typescript/SKILL.md) | Vue + TypeScript 前端开发 |
| [Vue + Vite](skills/vue-vite/SKILL.md) | Vue + Vite 前端开发 |
...
| Skill | 说明 |
|-------|------|
| [Android (Kotlin)](skills/android-kotlin/SKILL.md) | Android Kotlin 应用开发 |
...
| Skill | 说明 |
|-------|------|
| [SQL](skills/sql/SKILL.md) | SQL 标准查询语言 |
| [MySQL](skills/mysql/SKILL.md) | MySQL 数据库开发 |
| [PostgreSQL](skills/postgresql/SKILL.md) | PostgreSQL 数据库开发 |
| [SQL Server](skills/sqlserver/SKILL.md) | SQL Server 数据库开发 |
| [Oracle](skills/oracle/SKILL.md) | Oracle 数据库开发 |
